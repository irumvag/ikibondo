...
// Map route prefixes → readable page titles (longest prefix wins)
const PAGE_TITLES: Record<string, string> = {
  ...
  '/admin/health-records':    'Health Records',
  '/admin/vaccinations':      'Vaccinations',
  '/admin/referrals':         'Referrals',
  '/admin/consultations':     'Consultations',
  '/admin/visit-requests':    'Visit Requests',
  '/admin/closed-cases':      'Closed Cases',
  '/admin/broadcasts':        'Broadcasts',
  '/admin/dhis2':             'DHIS2 Sync',
  '/admin':                   'Overview',
  ...
  '/supervisor/staff':        'Camp Staff',
  '/supervisor/zones':        'Zones',
  '/supervisor/analytics':    'Analytics',
  '/supervisor/health-records': 'Health Records',
  '/supervisor/referrals':    'Referrals',
  '/supervisor/consultations': 'Consultations',
  '/supervisor/visit-requests': 'Visit Requests',
  '/supervisor/clinic-sessions': 'Clinic Sessions',
  '/supervisor/closed-cases': 'Closed Cases',
  '/supervisor/broadcast':    'Broadcast',
  '/supervisor/ai-oversight': 'AI Oversight',
  '/supervisor':              'Zone Overview',
  '/nurse/children':          'Children',
  '/nurse/records':           'Health Records',
  '/nurse/register':          'Register Child',
  '/nurse/approvals':         'Parent Approvals',
  '/nurse/guardians':         'Guardians',
  '/nurse/vaccines/session':  'Clinic Session',
  '/nurse/vaccines':          'Vaccinations',
  '/nurse/referrals':         'Referrals',
  '/nurse/visit-requests':    'Visit Requests',
  '/nurse/closed-cases':      'Closed Cases',
  '/nurse/inbox':             'Consultations',
  '/nurse/scan':              'Scan QR',
  '/nurse':                   'Overview',
  '/chw/today':               "Today's Plan",
  '/chw/visit':               'New Visit',
  '/chw/vaccines':            'Vaccination Queue',
  '/chw/sync':                'Sync Queue',
  '/chw/scan':                'Scan QR',
  '/chw/children':            'Children',
  '/chw/parents':             'Families',
  '/chw/records':             'Health Records',
  '/chw/requests':            'Visit Requests',
  '/chw/consultations':       'Consultations',
  '/chw/referrals':           'Referrals',
  '/chw/settings':            'Settings',
  '/chw':                     'My Caseload',
  '/parent/children':         'My Children',
  '/parent/vaccines':         'Vaccination Card',
  '/parent/notifications':    'Notifications',
  '/parent/request-visit':    'Request Visit',
